package site.kotty_kov.powertodo.todolist.main.inprogress.view.recycler
...
import site.kotty_kov.powertodo.todolist.main.inprogress.view.recycler.InProgressSwipeHelper.UnderlayButton as UnderlayButton1


abstract class InProgressSwipeHelper(private val recyclerView: RecyclerView) :
    ItemTouchHelper.SimpleCallback(
        ItemTouchHelper.ACTION_STATE_IDLE,
        ItemTouchHelper.RIGHT
    ) {
    private var swipedPosition = -1
    private val buttonsBuffer: MutableMap<Int, List<UnderlayButton1>> = mutableMapOf()
    ...
    private fun drawButtons(
        canvas: Canvas,
        buttons: List<UnderlayButton1>,
        itemView: View,
        dX: Float
    ) {
        var start = 0

        val margin = itemView.context.resources.displayMetrics.density * 3
    ...
    abstract fun instantiateUnderlayButton(position: Int): List<UnderlayButton1>
    ...
    class UnderlayButton(
        ...
        fun draw(canvas: Canvas, rect: RectF) {
            ...
            val pix = context.resources.displayMetrics.density
            canvas.drawRoundRect(rect, 6f * pix, 6f * pix, paint)
...
private fun List<UnderlayButton1>.intrinsicWidth(): Float {
